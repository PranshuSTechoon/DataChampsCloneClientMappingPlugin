...
namespace CloneClientMappingPlugin
{
 ...
 <condition attribute='infcf_employeemaster' operator='null' />
                    ...
                    {
                        EmployeeMaster = employeemasterEntity.GetAttributeValue<string>("infcf_employeemasterid"),
                        EmployeeIdentification = employeemasterEntity.GetAttributeValue<string>("infcf_employeeidentification")
                    };

                    // Update the target entity with the found Employee Master ID
                    targetEntity["infcf_employeemaster"] = new EntityReference("infcf_verifiedemployee", new Guid(employeeMaster.EmployeeMaster));
